    ...
    <section className="py-8 sm:py-16 lg:py-20 bg-white">
      <div className="max-w-7xl mx-auto px-5 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-6 sm:mb-10 lg:mb-14">
          <h2 className="text-xl sm:text-3xl lg:text-4xl font-bold text-[#084a6f] leading-tight">
        ...
        <div className="grid lg:grid-cols-2 gap-6 lg:gap-12 items-stretch">
          ...
          <div className="order-1 lg:order-2 flex flex-col justify-center space-y-4 sm:space-y-5">
            {/* Feature highlights — compact on mobile */}
            <div className="space-y-3 sm:space-y-5">
              <div className="flex items-start gap-3 sm:gap-4">
                ...
                <div>
                  <span className="text-sm sm:text-lg font-bold text-gray-900">Bill Analyzer</span>
                  <p className="text-xs sm:text-base text-gray-600 mt-0.5">Upload your bill. We find hidden fees and overcharges automatically.</p>
                </div>
              </div>
              <div className="flex items-start gap-3 sm:gap-4">
                <div className="w-10 h-10 sm:w-11 sm:h-11 bg-blue-100 rounded-xl flex items-center justify-center flex-shrink-0">
                  <Search className="w-4 h-4 sm:w-5 sm:h-5 text-[#0A5C8C]" />
                </div>
                <div>
                  <span className="text-sm sm:text-lg font-bold text-gray-900">Smart Plan Matching</span>
                  <p className="text-xs sm:text-base text-gray-600 mt-0.5">Plans ranked by real value — not by who pays us the most.</p>
                </div>
              </div>
              <div className="flex items-start gap-3 sm:gap-4">
                ...
                <div>
                  <span className="text-sm sm:text-lg font-bold text-gray-900">No Bias. No Sponsored Rankings.</span>
                  <p className="text-xs sm:text-base text-gray-600 mt-0.5">40+ providers compete so the best deal always wins.</p>
                </div>
              </div>
            </div>
            ...
            <div className="flex items-center justify-between sm:justify-start sm:gap-8 pt-1 sm:pt-2">
              <div className="text-center">
                <span className="text-lg sm:text-2xl font-bold text-[#084a6f]">50K+</span>
                <span className="text-[10px] sm:text-sm text-gray-500 block">Households switched</span>
              </div>
              <div className="w-px h-8 sm:h-10 bg-gray-200"></div>
              <div className="text-center">
                <span className="text-lg sm:text-2xl font-bold text-[#084a6f]">12</span>
                <span className="text-[10px] sm:text-sm text-gray-500 block">States covered</span>
              </div>
              <div className="w-px h-8 sm:h-10 bg-gray-200"></div>
              <div className="text-center">
                <span className="text-lg sm:text-2xl font-bold text-[#FF6B35]">$600+</span>
                <span className="text-[10px] sm:text-sm text-gray-500 block">Avg. annual savings</span>
              </div>
            </div>
