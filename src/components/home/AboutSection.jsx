    ...
    <section className="py-10 sm:py-16 lg:py-20 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-stretch">
          {/* Image — same height as text column */}
          <div className="order-2 lg:order-1">
            <div className="relative rounded-2xl overflow-hidden shadow-2xl h-full min-h-[360px] sm:min-h-[420px]">
              <img
          ...
          {/* Content */}
          <div className="order-1 lg:order-2 flex flex-col justify-center space-y-5">
            {/* Feature highlights */}
            ...
            <div className="flex flex-wrap gap-3 pt-2">
              <Link to={createPageUrl("BillAnalyzer")} className="inline-flex items-center justify-center bg-[#FF6B35] hover:bg-[#e55a2b] text-white font-semibold px-8 py-3.5 text-base rounded-xl transition-all duration-300 shadow-lg">
                <FileText className="w-4 h-4 mr-2" />
                Try the Bill Analyzer
              </Link>
              <Link to={createPageUrl("AboutUs")} className="inline-flex items-center justify-center border-2 border-[#0A5C8C] text-[#0A5C8C] hover:bg-[#0A5C8C] hover:text-white font-semibold px-8 py-3.5 text-base rounded-xl transition-all duration-300">
                Learn About Us
              </Link>
            </div>
          </div>
