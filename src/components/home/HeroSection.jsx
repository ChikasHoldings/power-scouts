...
import { Star, Sparkles, CheckCircle, Shield, FileText, ArrowRight } from "lucide-react";
          ...
          <div className="space-y-3 sm:space-y-5 lg:space-y-6 animate-fade-in-up">
            ...
            <div>
              ...
              <p className="text-base sm:text-lg lg:text-xl text-gray-600 leading-relaxed max-w-xl">
                Upload your bill or enter your ZIP. We'll match you with a better plan from 40+ providers across 12 states.
              </p>
            </div>
            ...
            >
              ...
              <div className="flex-1">
                <span className="text-sm font-semibold text-gray-900">Have a bill? Upload it for a free analysis.</span>
                <span className="text-xs text-gray-500 block">Our Bill Analyzer finds hidden charges other tools miss.</span>
              </div>
            ...
            <div className="flex items-center gap-3 sm:gap-4">
              ...
              <div className="text-sm sm:text-base">
                ...
                <p className="text-gray-600 text-xs sm:text-sm font-medium leading-tight">Joined by <span className="text-[#084a6f] font-bold">50,000+</span> households saving avg <span className="text-[#FF6B35] font-bold">$600/yr</span></p>
              </div>
            </div>
