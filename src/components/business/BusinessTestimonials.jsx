...
const testimonials = [
  {
    ...
    testimonial: "Switching to a competitive supplier through Power Scouts saved us nearly $30k in the first year. The volume discounts for our manufacturing facility were game-changing.",
  ...
  },
  {
    ...
    testimonial: "Managing energy costs across 5 retail locations was challenging. Power Scouts found us a plan with consistent rates that works for all our stores.",
    contact: "Sarah Chen",
  ...
  },
  {
    ...
    testimonial: "Healthcare facilities can't compromise on reliability. We needed a provider offering both competitive rates and 24/7 support. Power Scouts delivered exactly that.",
  ...
  },
  {
    ...
    testimonial: "Our warehouse operates 24/7, so electricity is a major expense. The fixed-rate plan Power Scouts recommended has stabilized our operating costs significantly.",
  ...
  },
  {
    ...
    testimonial: "Running 3 restaurants in NYC with high energy costs was eating into our margins. Power Scouts helped us save over $8k annually across all locations.",
