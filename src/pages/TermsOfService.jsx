  ...
  const sections = [
      ...
      content: (
        <>
          <p className="text-gray-600 mb-3">
            By accessing, browsing, or using the ElectricScouts website and services (collectively, the "Service"), you acknowledge that you have read, understood, and agree to be bound by these Terms of Service ("Terms"). These Terms constitute a legally binding agreement between you and ElectricScouts, operated by Chikas Holdings LLC.
          </p>
          <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
            <p className="text-blue-900 text-sm font-medium">
              If you do not agree to these Terms, you must discontinue use of the Service immediately. Your continued use of ElectricScouts after any modifications to these Terms constitutes acceptance of the updated Terms.
            </p>
          </div>
        </>
      )
      ...
      content: (
        <>
          <p className="text-gray-600 mb-4">
            ElectricScouts is a free electricity rate comparison platform that enables users to compare electricity plans from multiple providers across deregulated energy markets in the United States.
          </p>
    ...
    },
    {
      ...
      content: (
        <>
          <p className="text-gray-600 mb-3">
            While ElectricScouts strives to provide accurate, current, and comprehensive information, electricity rates, plan details, provider availability, and market conditions are subject to change without notice. All information displayed on our platform is for comparison and informational purposes only.
          </p>
          ...
          <p className="text-gray-600 text-sm">
            ElectricScouts does not guarantee the accuracy, completeness, or timeliness of any information on the platform. We are not responsible for errors, omissions, or outdated information provided by third-party electricity providers.
          </p>
        </>
      )
    },
    {
      ...
      content: (
        <p className="text-gray-600">
          Savings estimates, rate comparisons, and cost projections displayed on ElectricScouts are illustrative and based on general assumptions about average electricity usage, current market rates, and standard plan terms. Actual savings will vary based on your individual electricity consumption, location, chosen plan, credit score, seasonal usage patterns, and other factors. ElectricScouts expressly disclaims any guarantee of specific savings amounts. Past savings reported by other users do not guarantee future results. You are solely responsible for evaluating whether a particular electricity plan meets your needs.
        </p>
      )
    },
    {
      ...
      content: (
        <>
          <p className="text-gray-600 mb-4">By using ElectricScouts, you agree to the following responsibilities:</p>
          <div className="space-y-3">
            {[
              ...
              { title: "Lawful Use", desc: "Use the Service only for lawful purposes. You may not use ElectricScouts to engage in fraudulent, deceptive, or harmful activities." },
    ...
    },
    {
      ...
      content: (
        <p className="text-gray-600">
          All content, materials, logos, trademarks, service marks, trade names, graphics, user interfaces, visual designs, software, and code on the ElectricScouts platform are the exclusive property of ElectricScouts (Chikas Holdings LLC) or its licensors and are protected by United States and international copyright, trademark, and intellectual property laws. You may not reproduce, distribute, modify, create derivative works from, publicly display, or commercially exploit any content from ElectricScouts without prior written permission. Limited, non-commercial use of our content is permitted for personal reference only, provided proper attribution is given.
        </p>
      )
    },
    {
    ...
    },
    {
      ...
      content: (
        <>
          <p className="text-gray-600 mb-3">
            To the fullest extent permitted by applicable law, ElectricScouts (including its officers, directors, employees, agents, and affiliates) shall not be liable for any indirect, incidental, special, consequential, or punitive damages arising from or related to:
          </p>
          ...
          <p className="text-gray-600 text-sm">
            In no event shall ElectricScouts' total liability exceed the amount you paid to use the Service (which is zero, as our Service is free). This limitation applies regardless of the legal theory under which liability is asserted.
          </p>
        </>
      )
    },
      ...
      <div className="bg-gradient-to-r from-[#0A5C8C] to-[#084a6f] text-white py-16">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-blue-100 text-lg max-w-2xl">
            Please read these terms carefully before using ElectricScouts. By using our platform, you agree to be bound by these terms.
          </p>
